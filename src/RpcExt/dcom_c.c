...
static const RPC_CLIENT_INTERFACE IOXIDResolver___RpcClientInterface =
    {
...
RPC_IF_HANDLE IOXIDResolver_v0_0_c_ifspec = (RPC_IF_HANDLE)& IOXIDResolver___RpcClientInterface;

extern const MIDL_STUB_DESC IOXIDResolver_StubDesc;

static RPC_BINDING_HANDLE IOXIDResolver__MIDL_AutoBindHandle;
    ...
    /* [ref][out] */ DWORD *pAuthnHint)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IOXIDResolver_StubDesc,
    ...
    /* [in] */ SETID *pSetId)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IOXIDResolver_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[62],
                  ( unsigned char * )&hRpc);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [out] */ USHORT *pPingBackoffFactor)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IOXIDResolver_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[94],
                  ( unsigned char * )&hRpc);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [in] */ handle_t hRpc)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IOXIDResolver_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[162],
                  ( unsigned char * )&hRpc);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [ref][out] */ COMVERSION *pComVersion)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IOXIDResolver_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[188],
                  ( unsigned char * )&hRpc);
    return ( error_status_t  )_RetVal.Simple;
...
static const RPC_CLIENT_INTERFACE IRemoteActivation___RpcClientInterface =
    {
    sizeof(RPC_CLIENT_INTERFACE),
...
RPC_IF_HANDLE IRemoteActivation_v0_0_c_ifspec = (RPC_IF_HANDLE)& IRemoteActivation___RpcClientInterface;

extern const MIDL_STUB_DESC IRemoteActivation_StubDesc;

static RPC_BINDING_HANDLE IRemoteActivation__MIDL_AutoBindHandle;
    ...
    /* [size_is][out] */ HRESULT *pResults)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&IRemoteActivation_StubDesc,
                  (PFORMAT_STRING) &dcom__MIDL_ProcFormatString.Format[256],
                  ( unsigned char * )&hRpc);
...
static const MIDL_STUB_DESC IOXIDResolver_StubDesc = 
    {
    (void *)& IOXIDResolver___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &IOXIDResolver__MIDL_AutoBindHandle,
    0,
    0,
    ExprEvalRoutines,
    0,
...
static const MIDL_STUB_DESC IRemoteActivation_StubDesc = 
    {
    (void *)& IRemoteActivation___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &IRemoteActivation__MIDL_AutoBindHandle,
    0,
    0,
    ExprEvalRoutines,
    0,
