...
extern const MIDL_SERVER_INFO IUserService_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IUserService_ProxyInfo;
...
/* Object interface: IUserService, ver. 0.0,
   GUID={0x81331af6,0xe61d,0x405b,{0xbc,0x7b,0x81,0xc0,0x38,0x43,0xb4,0x9b}} */

#pragma code_seg(".orpc")
static const unsigned short IUserService_FormatStringOffsetTable[] =
    {
    0
    };
...
#pragma code_seg(".orpc")
static const FormatInfoRef IUserService_Ndr64ProcTable[] =
    {
    &__midl_frag2
    };


static const MIDL_SYNTAX_INFO IUserService_SyntaxInfo [  2 ] = 
    {
    {
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    0,
    Server__MIDL_ProcFormatString.Format,
    &IUserService_FormatStringOffsetTable[-3],
    ...
    0,
    0 ,
    (unsigned short *) &IUserService_Ndr64ProcTable[-3],
    0,
...
static const MIDL_STUBLESS_PROXY_INFO IUserService_ProxyInfo =
    {
    &Object_StubDesc,
    Server__MIDL_ProcFormatString.Format,
    &IUserService_FormatStringOffsetTable[-3],
    ...
    2,
    (MIDL_SYNTAX_INFO*)IUserService_SyntaxInfo
    
    };


static const MIDL_SERVER_INFO IUserService_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    Server__MIDL_ProcFormatString.Format,
    (unsigned short *) &IUserService_FormatStringOffsetTable[-3],
    0,
    (RPC_SYNTAX_IDENTIFIER*)&_NDR64_RpcTransferSyntax,
    2,
    (MIDL_SYNTAX_INFO*)IUserService_SyntaxInfo
    };
CINTERFACE_PROXY_VTABLE(4) _IUserServiceProxyVtbl = 
{
    &IUserService_ProxyInfo,
    &IID_IUserService,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* IUserService::Hello */
};

const CInterfaceStubVtbl _IUserServiceStubVtbl =
{
    &IID_IUserService,
    &IUserService_ServerInfo,
    4,
    0, /* pure interpreted */
...
{
    ( CInterfaceProxyVtbl *) &_IUserServiceProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _Server_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IUserServiceStubVtbl,
    0
};
